...
public class VehicleDAO {
    ...
    public List<Vehicle> byVIN(String vin) {
        return sortBy("v.vin = ?", vin);
    }
    public List<Vehicle> byPrice(double lowest, double highest) {
    ...
    public List<Vehicle> byYear(int lowest, int highest) {
    ...
    public List<Vehicle> byMileage(int lowest, int highest) {
    ...
    private List<Vehicle> sortBy(String condition, String... properties) {
    ...
    private void vehiclePreparedStatement(PreparedStatement prep, Vehicle vehicle) throws SQLException {

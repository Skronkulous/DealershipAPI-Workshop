...
public class SalesContractDAO {
    ...
    public SalesContract byID(int id) {
        String queryID = """
                SELECT *
    ...
    public void saveSC(SalesContract sc) {
        String query = """
    ...
    public void updateSC(SalesContract sc) {
        String queryUpdate = """
    ...
    private void savePrep(PreparedStatement prep, SalesContract sc) throws SQLException {
    ...
    private void updatePrep(PreparedStatement prep, SalesContract sc) throws SQLException {
    ...
    private SalesContract scSet(ResultSet rs) throws SQLException {
    ...
    private void errorHandling(SQLException e, String display) {
        e.printStackTrace();
